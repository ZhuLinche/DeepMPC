...
IxxVal = 0.000058286*1.10; 
IyyVal = 0.000071691*0.8;
IzzVal = 0.0001;
mVal = 0.067;
kVal = 0.0107;
lVal = 0.0624;
...
matlabFunction(transpose(f),'File','QuadrotorStateFcnMassCapacity',...
    'Vars',{transpose([state{:}]),transpose(control)});
% Create QuadrotorStateJacobianFcn.m 
matlabFunction(A, B,'File','QuadrotorStateJacobianFcnMassCapacity',...
    'Vars',{transpose([state{:}]),transpose(control)});
